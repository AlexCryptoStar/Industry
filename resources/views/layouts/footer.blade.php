            ...
            <div class="col-md-6 col-lg-3 mb-4 mb-md-0">
                <div class="contact-details">
                    ...
                    <ul class="list list-icons list-icons-lg">
                        <li class="mb-1"><i class="far fa-dot-circle text-color-primary"></i><p class="m-0">上海宝山区宝钢一村26号201室</p></li>
                        <li class="mb-1"><i class="fab fa-whatsapp text-color-primary"></i><p class="m-0"><a href="tel:8001234567">13795375098 ( 王雷 ) </a></p></li>
            ...
            <div class="row py-4">
                <div class="col-lg-1 d-flex align-items-center justify-content-center justify-content-lg-start mb-2 mb-lg-0">
                    <a class="logo pr-0 pr-lg-3">
                        <img alt="Porto Website Template" src="img/logo.jpg" class="opacity-5" height="28">
                    </a>
                </div>
